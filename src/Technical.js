  ...
  render() {
    return (
      <div>
        ...
        <h3>Personal</h3>
        <ul>
          <li><a href="http://itsjafer.com"><b>This website</b></a> - developed using ReactJS with React Router.</li>
          <li><a href="https://github.com/itsjafer/web-msngr"> <b>web-msngr</b> </a> - a personal messaging web app made using Angular, Mongo, Node.js, and Express and deployed using Heroku</li>
