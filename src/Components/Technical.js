      ...
      <div>
        <div className="Resume">
          <p>
            {' '}
            Here is a
            <a href="Resume.pdf" target="_blank" rel="noopener noreferrer"> direct link</a>
            {' '}
            to my resume; I am currently looking for internships and new grad opportunities!
            {' '}
          </p>
        </div>
        ...
        <ul>
          ...
          <li>
            <a href="http://itsjafer.com" target="_blank" rel="noopener noreferrer"><b>This website</b></a>
            {' '}
            - developed using ReactJS with React Router.
          </li>
          <li>
          ...
          <li>
            <a href="http://github.com/itsjafer/sorcery" target="_blank" rel="noopener noreferrer"><b>sorcery</b></a>
            {' '}
            - an object-oriented implementation of a card game based on Magic: The Gathering and Hearthstone written in C++
            {' '}
          </li>
        </ul>
        <h3>On-the-job</h3>
        <ul>
          ...
          <li>
            <b>Jupyterlab IAM Manager</b>
            {' '}
            @ Yelp - a JupyterLab extension that allows for management of AWS credentials from Jupyter itself
          </li>
          <li>
            <b>Habit Recommendation Model</b>
            {' '}
            @ Vida Health - prediction pipeline built on scikit-learn, pandas, and BigQuery to recommend habits for users based on historical data
          </li>
          <li>
            <b>Track and Trace</b>
            {' '}
            @ NLS - an ASP.NET web app that allows logistics clients to externally track shipments of cartons
          </li>
          <li>
            <b>Visitor Management System</b>
            {' '}
            @ NLS - a cross-platform React Native iOS/Android application that manages visitors and employee sign in and out
          </li>
          <li>
            <b>Fixed Income Permissions</b>
            {' '}
            @ BMO - a Razor MVC web application written in C# and JavaScript to manage permission to various tools at BMO
          </li>
          <li>
            <b>Axes Blotter</b>
            {' '}
            @ BMO - a desktop application written in C# using MVVM that allows bond traders at BMO Capital Markets to create, manage, and publish discounted bonds to clientele
          </li>
          <li>
            <b>Bond TradeHistory</b>
            {' '}
            @ BMO - a feature for a WPF application that allowed traders to view the sales history of bonds located in a database in Oracle SQL.
          </li>
          <li>
            <b>Bulk Trade Entry System</b>
            {' '}
            @ BMO - functionality written in C# that allows several trades to be generated at once and published to a RabbitMQ back-end to allow quicker workflows
          </li>
          <li>
            <b>Prospect</b>
            {' '}
            @ Camis - a web dashboard written in Node.js, jQuery with a PowerShell backend used by DevOps and FieldOps teams to remotely monitor, update, and deploy to clients
          </li>
        </ul>
        <h3>Miscellaneous</h3>
        <ul>
          ...
          <li>
            I&apos;ve got a
            <i> Bloomberg Market Concepts</i>
            {' '}
            certification using a Bloomberg Terminal
          </li>
